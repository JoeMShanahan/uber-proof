...
/* package uber-proof-0.1.0.0 */
#define VERSION_uber_proof "0.1.0.0"
#define MIN_VERSION_uber_proof(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "uber-proof-0.1.0.0-3gRQQgaKbokJNcLHSNxRVU"

#define CURRENT_PACKAGE_KEY "uber-proof-0.1.0.0-3gRQQgaKbokJNcLHSNxRVU"
